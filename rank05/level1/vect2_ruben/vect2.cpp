...
const int& vect2::operator[](int i) const {return (i == 0) ? _x : _y; }
...
vect2& vect2::operator++() { return *this += vect2(1, 1); }
vect2 vect2::operator++(int) { vect2 tmp(*this); ++(*this); return tmp; }
vect2& vect2::operator--() { return *this -= vect2(1, 1); }
vect2 vect2::operator--(int) { vect2 tmp(*this); --(*this); return tmp; }

bool vect2::operator==(const vect2& rhs) const { return _x == rhs._x && _y == rhs._y; }
bool vect2::operator!=(const vect2& rhs) const { return !(*this == rhs); }

vect2 operator+(vect2 lhs, const vect2& rhs) { return lhs += rhs; }
vect2 operator-(vect2 lhs, const vect2& rhs) { return lhs -= rhs; }
vect2 operator*(vect2 lhs, int scalar)       { return lhs *= scalar; }
vect2 operator*(int scalar, vect2 rhs)       { return rhs *= scalar; }
